...
\author{
  ...
  \firstname{Raul} \lastname{Lopes} \inst{8} \and
...
During the last year, the HEPiX IPv6 working group has been chasing
and supporting the transition to dual-stack services.
We have also investigated and fixed the reasons for the use
...
more places. We present the areas where this could be useful together with our future plans.
}
%
\maketitle
%
...
\label{sec-onlysix}
\input{section-3-IPv6-only-networking.tex}

\section{Conclusions and future plans}
\label{sec-concl}
\input{section-4-conclusions.tex}
