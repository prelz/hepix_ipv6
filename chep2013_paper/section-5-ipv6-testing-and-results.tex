...
We can see that, in general, transfers were fast, the graphs mostly peak to the left. Some sites (IHEP Beijing, Fermilab) have long tails for transfers out, though transfers to them are more successful.
