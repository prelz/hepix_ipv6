...
The successful adoption rate of dual-stack perfSONAR has led to a proposal %in late 2017 
...
\subsection{XrootD}
The other major method by which data is accessed, often remotely, is XrootD\cite{xrootd} most notably by the ALICE and CMS experiments. Currently, the Monit WLCG Transfers Monitoring Service at CERN %\cite{grafana-WLCG-Transfers} 
