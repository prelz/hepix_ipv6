...
\author{
  \firstname{Alastair} \lastname{Dewhurst}\inst{1}\fnsep\and
  \firstname{Thomas} \lastname{Finnern}\inst{2}\fnsep\and
  \firstname{Terry} \lastname{Froy}\inst{3}\fnsep\and
  \firstname{Costin} \lastname{Grigoras}\inst{4}\fnsep\and
  \firstname{Kashif} \lastname{Hafeez}\inst{1}\fnsep\and
  \firstname{Bruno} \lastname{Hoeft}\inst{5}\fnsep\and
  \firstname{David P.} \lastname{Kelsey}\inst{1}\fnsep\thanks{\email{david.kelsey@stfc.ac.uk}} \and
  \firstname{Fernando} \lastname{L\'opez~Mu\~noz}\inst{6,7}\fnsep\and
  \firstname{Edoardo} \lastname{Martelli}\inst{8}\fnsep\and
  \firstname{Raja} \lastname{Nandakumar}\inst{1}\fnsep\and
  \firstname{Kars} \lastname{Ohrenberg}\inst{2}\fnsep\and
  \firstname{Francesco} \lastname{Prelz}\inst{9}\fnsep\and
  \firstname{Duncan} \lastname{Rand}\inst{10}\fnsep\and
  \firstname{Andrea} \lastname{Sciab\`a}\inst{8}\fnsep\and
  \firstname{Daniel} \lastname{Traynor}\inst{3}\fnsep
}
